    ...
    const run = await runAutomationChecks(
      ...
      async (url) => {
        ...
        return {
          ...
          text: async () => '<html><head><meta property="og:title" content="???????"><meta name="description" content="Gustav Mahler Austrian composer, 1860-1911."><meta property="og:image" content="https://img.example.com/mahler.jpg"></head></html>',
        } as Response;
      },
    );
              ...
              choices: [
                {
                  message: {
                    content: JSON.stringify({
                      summary: "奥地利作曲家、指挥，晚期浪漫主义交响乐的重要代表。",
                      country: "Austria",
                      birthYear: 1860,
                      deathYear: 1911,
                      displayName: "??",
      ...
      async (url) => {
        ...
        if (value.includes("www.baidu.com/s")) {
          return {
            ...
            text: async () => '<html><body><div class="result"><h3><a href="https://www.example.com/mahler">Gustav Mahler</a></h3><div class="c-abstract">Gustav Mahler was an Austrian composer and conductor, 1860-1911.</div></div></body></html>',
          } as Response;
        }
