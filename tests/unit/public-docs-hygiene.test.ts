...
const ignoredFiles = new Set(["package-lock.json", "MANUAL_TEST_CHECKLIST.local.md", "2026-09-12-manual-isolation-and-collaboration-test.md", "public-docs-hygiene.test.ts"]);
