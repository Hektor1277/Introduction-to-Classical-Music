...
## 8. 与 owner 的集成方式
owner 与外部工具只通过本地 HTTP 通信，协议在 [`PROTOCOL.md`](/E:/Workspace/codex/Introduction%20to%20Classical%20Music/tools/recording-retrieval-service/PROTOCOL.md) 中定义。
...
2. [`PROTOCOL.md`](/E:/Workspace/codex/Introduction%20to%20Classical%20Music/tools/recording-retrieval-service/PROTOCOL.md)：理解 HTTP 协议与字段约束
3. 根目录 [`README.md`](/E:/Workspace/codex/Introduction%20to%20Classical%20Music/README.md)：理解当前仓库工程结构
